...
async def open_group_auction(group_id: str, req: CreateAuctionRequest):
    """
...
async def place_auction_bid(auction_id: str, req: PlaceBidRequest):
    """
...
async def close_group_auction(auction_id: str):
    """
