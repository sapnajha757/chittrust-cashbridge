...
async def get_group_health_summary(group_id: str):
    """
...
async def list_ai_risk_assessments(status: Optional[str] = None):
    """
    Lists AI Risk Assessments for authorized organizers & admins.
    """
...
async def get_ai_risk_assessment_details(assessment_id: str):
    """
...
async def review_ai_risk_assessment(assessment_id: str, req: ReviewAIRiskAssessmentRequest):
    """
...
async def get_trust_score_ai_explanation(language: str = "hi"):
    """
